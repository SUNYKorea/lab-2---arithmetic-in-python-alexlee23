...
# (-b + (b**2-4*a*c)**0.5)/(2*a)
x1 =  div (add(neg(b), sqrt(sub(exp(b, 2), 4*mult(a,c)))), mult(2,a))# TODO: write a code to compute the first root of the quadratic equation
x2 =  div (sub(neg(b), sqrt(sub(exp(b, 2), 4*mult(a,c)))), mult(2,a)) # TODO: then do the same for the second root 
